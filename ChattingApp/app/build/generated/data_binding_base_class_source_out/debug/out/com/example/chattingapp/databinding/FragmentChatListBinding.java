...
public final class FragmentChatListBinding implements ViewBinding {
  ...
  private FragmentChatListBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView fragmentChatListRecyclerview) {
    this.rootView = rootView;
    this.fragmentChatListRecyclerview = fragmentChatListRecyclerview;
  }
  ...
  public static FragmentChatListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.fragment_chat_list_recyclerview;
      RecyclerView fragmentChatListRecyclerview = ViewBindings.findChildViewById(rootView, id);
      if (fragmentChatListRecyclerview == null) {
        break missingId;
      }

      return new FragmentChatListBinding((LinearLayout) rootView, fragmentChatListRecyclerview);
    }
